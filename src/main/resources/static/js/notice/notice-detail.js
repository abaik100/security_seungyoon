...
function getNotice(notice){
	...
	noticeDetailDescription[1].innerHTML = "작성일:" + notice.userCreateDate;
	noticeDetailDescription[2].innerHTML = "조회수:" + notice.usernoticeCount;
	
	noticeContent.innerHTML = "<h3>첨부파일</h3>";
	
	let noticeFileArray = new Array();
	noitce.downloadFiles.forEach(file => {
